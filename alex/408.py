        ...
        if 'STARFRUIT' in state.order_depths:
            ...
            if len(self.star_historical_bid_prices) > 37:
                ...
                if not self.star_position_open:
                    ...
                    elif star_live_ask_price < star_latest_lower_band and star_ask_price_2:  # Long position
                        self.star_open_order_volume = min(abs(star_live_ask_volume), 20)
                        open_order_volume_2 = (self.star_open_order_volume + 5)
                ...
                # If position has been opened, check if the position can be closed
                    ...
                    if self.star_position_type == 'Short' and star_live_ask_price < star_latest_lower_band:
                    ...
                    elif self.star_position_type == 'Long' and star_live_bid_price > star_latest_upper_band and star_bid_price_2:
                        ...
                        star_orders.append(Order('STARFRUIT', star_order_price_2, -star_closing_volume))
                    ...
                    # Continue to close position if partially closed
                        ...
                        elif self.star_position_type == 'Long' and star_ask_price_2:
                            star_open_order_volume = min(abs(star_live_ask_volume), star_position)
                            open_order_price_2 = int((star_live_ask_price - star_ask_price_2) / 2)
                            star_orders.append(Order('STARFRUIT', open_order_price_2, star_open_order_volume))
