            ...
            if len(self.historical_prices) > 20:
                ...
                if not self.position_open:
                    if mid_price > latest_upper_band:
                        ...
                        orders.append(Order('STARFRUIT', best_bid_price, -self.open_order_volume))
                        print("open upper")
                        ...
                        orders.append(Order('STARFRUIT', best_ask_price, self.open_order_volume))
                        print("open lower")
                        self.position_open = True
                    ...
                    if not self.partially_closed:
                        if self.position_type == 'Short' and mid_price < latest_predicted_price:
                            ...
                            orders.append(Order('STARFRUIT', best_ask_price, closing_volume))
                            ...
                            print(closing_volume)
                            orders.append(Order('STARFRUIT', best_bid_price, -closing_volume))
                            self.remaining_quantity -= closing_volume
                            if self.remaining_quantity > 0:
                        ...
                        if self.position_type == 'Short' and mid_price < latest_predicted_price:
                            ...
                            orders.append(Order('STARFRUIT', best_ask_price, order_quantity))
                            ...
                            print(order_quantity)
                            orders.append(Order('STARFRUIT', best_bid_price, -order_quantity))
                            self.remaining_quantity -= order_quantity
                            if self.remaining_quantity > 0:
                                self.partially_closed = True
                                self.position_open = True
