            ...
            if len(self.historical_bid_prices) > 20:
                ...
                if not self.position_open:
                    if live_bid_price > latest_upper_band:
                        ...
                        orders.append(Order('AMETHYSTS', live_bid_price, -self.open_order_volume))
                        print("open upper")
                        ...
                        orders.append(Order('AMETHYSTS', live_ask_price, self.open_order_volume))
                        print("open lower")
                    ...
                    if not self.partially_closed:
                        if self.position_type == 'Short' and (live_ask_price < latest_lower_band or live_ask_price < self.latest_price):
                            ...
                            orders.append(Order('AMETHYSTS', live_ask_price, closing_volume))
                            ...
                            orders.append(Order('AMETHYSTS', live_bid_price, -closing_volume))
                            self.remaining_quantity -= closing_volume
                            if self.remaining_quantity > 0:
                        ...
                        if self.position_type == 'Short' and (live_ask_price < latest_lower_band or live_ask_price < self.latest_price):
                            ...
                            orders.append(Order('AMETHYSTS', live_ask_price, order_quantity))
                            ...
                            orders.append(Order('AMETHYSTS', live_bid_price, -order_quantity))
                            self.remaining_quantity -= order_quantity
                            if self.remaining_quantity > 0:
                                self.partially_closed = True
                                self.position_open = True
